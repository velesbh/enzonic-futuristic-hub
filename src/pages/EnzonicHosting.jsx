...
const PlanCard = ({ title, price, features, icon: Icon, description }) => (
  <motion.div
    whileHover={{ scale: 1.05 }}
...
const CustomPlanButton = () => (
  <div className="text-center mt-8">
    ...
    <Button variant="outline" className="text-white border-green-400 bg-gray-700 hover:bg-green-600 hover:text-white transition-colors duration-300">
      Contact Us
    </Button>
  </div>
);
