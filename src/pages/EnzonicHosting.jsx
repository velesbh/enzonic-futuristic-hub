  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold mb-8 text-center text-primary">Why Choose Enzonic Hosting?</h2>
          <AnimatedGrid>
        ...
        >
          <h2 className="text-4xl font-bold mb-8 text-center text-primary">Our Minecraft Hosting Solutions</h2>
          <Tabs>
            <TabList className="flex justify-center mb-8">
              <Tab className="px-4 py-2 text-lg cursor-pointer hover:text-primary transition-colors duration-300">Budget</Tab>
              <Tab className="px-4 py-2 text-lg cursor-pointer hover:text-primary transition-colors duration-300">Normal</Tab>
              <Tab className="px-4 py-2 text-lg cursor-pointer hover:text-primary transition-colors duration-300">Extreme</Tab>
            </TabList>
            ...
            {['budget', 'normal', 'extreme'].map((tier) => (
              <TabPanel key={tier}>
                ...
                {tier === 'extreme' && (
                  <p className="text-center text-destructive font-bold mb-8">{plans.minecraft[tier].disclaimer}</p>
                )}
                <AnimatedGrid>
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-8">Join thousands of satisfied customers and experience the Enzonic difference today!</p>
